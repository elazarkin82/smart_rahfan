...
"            <div class=\"search-crop-overlay\" id=\"searchCropOverlay\"></div>\n"
"        </div>\n"
...
"const searchCropOverlay = document.getElementById('searchCropOverlay');\n"
"\n"
"function updateSearchCropOverlay() {\n"
"    if (!img || !searchCropOverlay) {\n"
"        return;\n"
"    }\n"
"    const w = img.clientWidth;\n"
"    const h = img.clientHeight;\n"
"    if (w <= 0 || h <= 0) {\n"
"        searchCropOverlay.style.display = 'none';\n"
"        return;\n"
"    }\n"
"    const side = Math.min(w, h);\n"
"    searchCropOverlay.style.display = 'block';\n"
"    searchCropOverlay.style.left = (img.offsetLeft + ((w - side) / 2)) + 'px';\n"
"    searchCropOverlay.style.top = (img.offsetTop + ((h - side) / 2)) + 'px';\n"
"    searchCropOverlay.style.width = side + 'px';\n"
"    searchCropOverlay.style.height = side + 'px';\n"
"}\n"
"\n"
"img.addEventListener('load', updateSearchCropOverlay);\n"
"window.addEventListener('resize', updateSearchCropOverlay);\n"
"setInterval(updateSearchCropOverlay, 1000);\n"
...
"            toggleAutonomous(checkbox.checked);\n"
"        }\n"
"        return;\n"
"    }\n"
"    \n"
...
"    \n"
"    if (activeKeys['KeyW']) { p = 500; active = true; }\n"
"    if (activeKeys['KeyS']) { p = -500; active = true; }\n"
"    if (activeKeys['KeyA']) { r = -500; active = true; }\n"
"    if (activeKeys['KeyD']) { r = 500; active = true; }\n"
"    \n"
"    if (isCtrl) {\n"
